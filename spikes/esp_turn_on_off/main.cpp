...
//* https://github.com/debsahu/ESP_External_Interrupt/tree/master
...
IPAddress server(192, 168, 0, 111); // MQTT Server IP
...
{
    // config static IP
    IPAddress ip(192, 168, 1, 123);     // where yy is the desired IP Address
